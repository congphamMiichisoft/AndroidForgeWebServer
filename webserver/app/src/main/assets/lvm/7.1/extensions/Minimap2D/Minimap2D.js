...
/* harmony import */ var _MinimapUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MinimapUtils */ "./extensions/Minimap2D/MinimapUtils.js");
...
/* harmony import */ var _MinimapEvents__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MinimapEvents */ "./extensions/Minimap2D/MinimapEvents.js");
/* harmony import */ var _MinimapCanvas__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./MinimapCanvas */ "./extensions/Minimap2D/MinimapCanvas.js");
/* harmony import */ var _MinimapPanel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./MinimapPanel */ "./extensions/Minimap2D/MinimapPanel.js");
/* harmony import */ var _ThumbnailUtils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ThumbnailUtils */ "./extensions/Minimap2D/ThumbnailUtils.js");
...
MinimapExtension = /*#__PURE__*/function (_Autodesk$Viewing$Ext) {_inherits(MinimapExtension, _Autodesk$Viewing$Ext);
  function MinimapExtension(viewer) {var _this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};_classCallCheck(this, MinimapExtension);
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MinimapExtension).call(this, viewer, options));
    _this._isEnabled = false;
    _this.isMobile = Autodesk.Viewing.isMobileDevice();
    _this.initialSize = _this.options.initialSize || null;
    _this.wasInit = false;return _this;
  }
  ...
  /**
     ...
     * @private
    */_createClass(MinimapExtension, [{ key: "setEnabled", value: function setEnabled(
    isEnabled) {
      this._isEnabled = isEnabled;

      if (this._isEnabled) {
        if (!this.wasInit) {
          this.init(); // Will trigger resize, so canvas will be drawn
        } else {
          this.onCameraChange(false);
        }
      } else {
        this._setVisibility(false, false);
      }
    }
    ...
    {var _this2 = this;
      ...
      this.panel = new _MinimapPanel__WEBPACK_IMPORTED_MODULE_4__["default"](this.viewer.container, 10, 10, { isMobile: this.isMobile, addFooter: false });
      this.modelBBox = this.viewer.model.getBoundingBox().clone();
      ...
      this.prefetchThumbnails(['large', 'medium']).then(function () {
        if (!_this2.wasInit) return Promise.reject({ description: 'Load canceled', error: 'cancel' });

        _this2.createMinimapCanvas();
        return _this2.minimapCanvas.setSize(_this2.getInitialSize());
      }).then(function () {
        if (!_this2.wasInit) return Promise.reject({ description: 'Load canceled', error: 'cancel' });

        var hasToCheckThumbnail = !_this2.viewer.model.getData().isLeaflet && !Object(_MinimapUtils__WEBPACK_IMPORTED_MODULE_0__["getModelExtension"])(_this2.viewer).startsWith('rvt');
        if (hasToCheckThumbnail && !_ThumbnailUtils__WEBPACK_IMPORTED_MODULE_5__["default"].isThumbnailValid(_this2.minimapCanvas.backgroundCanvas)) {
          console.log('Invalid thumbnail!');
        } else {
          _this2.panel.appendElement(_this2.minimapCanvas.canvasContainer);
        }
        _this2.addListeners();
      }).catch(function (e) {
        console.log('Minimap error: ', e.description);
        if (!_this2.minimapCanvas && e.error !== 'cancel') {// Create mock canvas
          _this2.createMinimapCanvas();
          _this2.addListeners();
        }
      });
    ...
    {var _this3 = this;
      this.minimapCanvas = new _MinimapCanvas__WEBPACK_IMPORTED_MODULE_3__["default"](this.backgroundImgs || {}, this.modelWidth, this.modelHeight);
      this.onCanvasResizeBinded = function (e) {return _this3.onCanvasResize(e);};
      this.minimapCanvas.addEventListener(_MinimapEvents__WEBPACK_IMPORTED_MODULE_2__["MINIMAP_EVENTS"].MINIMAP_RESIZE_EVENT, this.onCanvasResizeBinded);
    }
      ...
      */ }, { key: "getInitialSize", value: function getInitialSize()
    {
      ...
      return this.isMobile ? _MinimapThumbnail__WEBPACK_IMPORTED_MODULE_1__["thumbnailDefaultSizes"]['mobile'] : _MinimapThumbnail__WEBPACK_IMPORTED_MODULE_1__["thumbnailDefaultSizes"]['web'];
    }
    ...
    requestedSizes) {var _this4 = this;
      this.backgroundImgs = {};
      var params = {
        docId: this.docId,
        guid: this.itemId,
        token: this.viewer.config.accessToken,
        acmsession: this.acmSessionId };

      var requests = requestedSizes.map(function (val) {return Object(_MinimapThumbnail__WEBPACK_IMPORTED_MODULE_1__["fetchThumbnail"])(params, val, _this4.backgroundImgs);});
    ...
    {var _this5 = this;
      this.onMouseDownBinded = function (e) {return _this5.onMouseDown(e);};
      this.onMouseMoveBinded = function (e) {return _this5.onMouseMove(e);};
      this.onMouseUpBinded = function (e) {return _this5.onMouseUp(e);};

      if (this._isTouch()) {
        this.minimapCanvas.addListenerToCanvas('touchstart', this.onMouseDownBinded);
        this.minimapCanvas.addListenerToCanvas('touchmove', this.onMouseMoveBinded);
        this.minimapCanvas.addListenerToCanvas('touchend', this.onMouseUpBinded);
      }

      if (!this.isMobile) {
        this.minimapCanvas.addListenerToCanvas('mousedown', this.onMouseDownBinded);
        this.minimapCanvas.addListenerToCanvas('mousemove', this.onMouseMoveBinded);
        this.minimapCanvas.addListenerToCanvas('mouseup', this.onMouseUpBinded);

        this.onMouseLeaveBinded = function (e) {return _this5.onMouseLeave(e);};
        this.onMouseWheelBinded = function (e) {return _this5.onMouseWheel(e);};

        this.minimapCanvas.addListenerToCanvas('mouseleave', this.onMouseLeaveBinded);
        this.minimapCanvas.addListenerToCanvas('mousewheel', this.onMouseWheelBinded);
        this.minimapCanvas.addListenerToCanvas('DOMMouseScroll', this.onMouseWheelBinded); // firefox
      }

      this.onCameraChangeBinded = function (e) {return _this5.onCameraChange(true);};

      this.viewer.addEventListener(Autodesk.Viewing.CAMERA_CHANGE_EVENT, this.onCameraChangeBinded);

      this.onCloseButtonBinded = function () {return _this5.onCloseButton();};
      this.panel.addListenerToCloseButton(this.onCloseButtonBinded);
    }
      ...
      */ }, { key: "onCloseButton", value: function onCloseButton()
    {
      if (this.viewer.toolbar) {
        var control = this.viewer.viewerSettingsPanel.getControl(this.minimapSettingsCheckboxId);
        if (control) {
    ...
    /**
       * @private
      */ }, { key: "onCanvasResize", value: function onCanvasResize()
    {
    ...
    /**
       ...
       * @return {object} The position in minimap coordinates
    ...
    /**
       ...
       * @return {object} The position in model coordinates
    ...
    /**
       ...
       * @private
      */ }, { key: "addEnableCheckboxToSettings", value: function addEnableCheckboxToSettings()
    {var _this6 = this;
      this.viewer.prefs.add('showMinimap', true, '2d');
      this.setEnabled(this.viewer.prefs['showMinimap']);
      var navTab = Autodesk.Viewing.Extensions.ViewerSettingTab.Navigation;
      this.viewer.viewerSettingsPanel.addLabel(navTab, "Minimap");
      this.minimapSettingsCheckboxId = this.viewer.viewerSettingsPanel.addCheckbox(navTab, 'Show minimap', 'Toggles availability of the Minimap', true, function (checked) {return _this6.setEnabled(checked);}, 'showMinimap');
    }

    /**
       * Happens after the viewer's toolbar was created
       * @alias Autodesk.Viewing.Extensions.MinimapExtension#onToolbarCreated
      */ }, { key: "onToolbarCreated", value: function onToolbarCreated()
    {
      this.addEnableCheckboxToSettings();
    } }, { key: "load",
                        ...
                        */value: function load()
    {
      ...
      this.itemId = node.guid();
      this.acmSessionId = doc.acmSessionId;
      this.docId = doc.myPath;

      return true;
    }

    /**
       * Occures when camera changes
      ...
      */ }, { key: "destroyUI", value: function destroyUI()
    {
      if (this.viewer.toolbar) {
        var control = this.viewer.viewerSettingsPanel.getControl(this.minimapSettingsCheckboxId);
        if (control) {
          this.viewer.viewerSettingsPanel.removeCheckbox(control);
        }
      }
      ...
      */ }, { key: "unload", value: function unload()
    {
      if (this.minimapCanvas) {
        if (this._isTouch()) {
          this.minimapCanvas.removeListenerFromCanvas('touchstart', this.onMouseDownBinded);
          this.minimapCanvas.removeListenerFromCanvas('touchmove', this.onMouseMoveBinded);
          this.minimapCanvas.removeListenerFromCanvas('touchend', this.onMouseUpBinded);
        }

        if (!this.isMobile) {
          this.minimapCanvas.removeListenerFromCanvas('mousedown', this.onMouseDownBinded);
          this.minimapCanvas.removeListenerFromCanvas('mousemove', this.onMouseMoveBinded);
          this.minimapCanvas.removeListenerFromCanvas('mouseup', this.onMouseUpBinded);

          this.minimapCanvas.removeListenerFromCanvas('mouseleave', this.onMouseLeaveBinded);
          this.minimapCanvas.removeListenerFromCanvas('mousewheel', this.onMouseWheelBinded);
          this.minimapCanvas.removeListenerFromCanvas('DOMMouseScroll', this.onMouseWheelBinded); // firefox
        }
...
/* harmony import */ var _MinimapEvents__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MinimapEvents */ "./extensions/Minimap2D/MinimapEvents.js");
/* harmony import */ var _MinimapThumbnail__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MinimapThumbnail */ "./extensions/Minimap2D/MinimapThumbnail.js");
function _typeof(obj) {if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {_typeof = function _typeof(obj) {return typeof obj;};} else {_typeof = function _typeof(obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;};}return _typeof(obj);}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}function _possibleConstructorReturn(self, call) {if (call && (_typeof(call) === "object" || typeof call === "function")) {return call;}return _assertThisInitialized(self);}function _assertThisInitialized(self) {if (self === void 0) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return self;}function _getPrototypeOf(o) {_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {return o.__proto__ || Object.getPrototypeOf(o);};return _getPrototypeOf(o);}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function");}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } });if (superClass) _setPrototypeOf(subClass, superClass);}function _setPrototypeOf(o, p) {_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {o.__proto__ = p;return o;};return _setPrototypeOf(o, p);}

var

MinimapCanvas = /*#__PURE__*/function (_Autodesk$Viewing$Eve) {_inherits(MinimapCanvas, _Autodesk$Viewing$Eve);
  function MinimapCanvas(backgroundImgs, docWidth, docHeight) {var _this;var initialSize = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'large';_classCallCheck(this, MinimapCanvas);
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MinimapCanvas).call(this));
    _this.minimapSize = _MinimapThumbnail__WEBPACK_IMPORTED_MODULE_2__["thumbnailSizes"][initialSize];
    ...
    newSize) {var _this2 = this;
      newSize = typeof newSize === 'string' ? _MinimapThumbnail__WEBPACK_IMPORTED_MODULE_2__["thumbnailSizes"][newSize] : newSize;
      return new Promise(function (resolve, reject) {
        ...
        for (var size in _MinimapThumbnail__WEBPACK_IMPORTED_MODULE_2__["thumbnailSizes"]) {
          if (newSize <= _MinimapThumbnail__WEBPACK_IMPORTED_MODULE_2__["thumbnailSizes"][size] && _MinimapThumbnail__WEBPACK_IMPORTED_MODULE_2__["thumbnailSizes"][size] < lowestBound && _this2.backgroundImgs.hasOwnProperty(size)) {
            thumbnailSize = size;
            lowestBound = _MinimapThumbnail__WEBPACK_IMPORTED_MODULE_2__["thumbnailSizes"][size];
          }
        }
        ...
        _this2.fireEvent(_MinimapEvents__WEBPACK_IMPORTED_MODULE_1__["MINIMAP_EVENTS"].MINIMAP_RESIZE_EVENT);
      });
    ...
    thumbnailSize) {
      var size = _MinimapThumbnail__WEBPACK_IMPORTED_MODULE_2__["thumbnailSizes"][thumbnailSize];
...
/***/ "./extensions/Minimap2D/MinimapEvents.js":
/*!***********************************************!*\
  !*** ./extensions/Minimap2D/MinimapEvents.js ***!
  \***********************************************/
/*! exports provided: MINIMAP_EVENTS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MINIMAP_EVENTS", function() { return MINIMAP_EVENTS; });
var MINIMAP_EVENTS = {
  MINIMAP_RESIZE_EVENT: 'minimap.resize' };
...
function _typeof(obj) {if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {_typeof = function _typeof(obj) {return typeof obj;};} else {_typeof = function _typeof(obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;};}return _typeof(obj);}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}function _possibleConstructorReturn(self, call) {if (call && (_typeof(call) === "object" || typeof call === "function")) {return call;}return _assertThisInitialized(self);}function _assertThisInitialized(self) {if (self === void 0) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return self;}function _get(target, property, receiver) {if (typeof Reflect !== "undefined" && Reflect.get) {_get = Reflect.get;} else {_get = function _get(target, property, receiver) {var base = _superPropBase(target, property);if (!base) return;var desc = Object.getOwnPropertyDescriptor(base, property);if (desc.get) {return desc.get.call(receiver);}return desc.value;};}return _get(target, property, receiver || target);}function _superPropBase(object, property) {while (!Object.prototype.hasOwnProperty.call(object, property)) {object = _getPrototypeOf(object);if (object === null) break;}return object;}function _getPrototypeOf(o) {_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {return o.__proto__ || Object.getPrototypeOf(o);};return _getPrototypeOf(o);}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function");}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } });if (superClass) _setPrototypeOf(subClass, superClass);}function _setPrototypeOf(o, p) {_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {o.__proto__ = p;return o;};return _setPrototypeOf(o, p);}var MinimapPanel = /*#__PURE__*/function (_Autodesk$Viewing$UI$) {_inherits(MinimapPanel, _Autodesk$Viewing$UI$);
  function MinimapPanel(parentContainer, x, y, options) {var _this;_classCallCheck(this, MinimapPanel);
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MinimapPanel).call(this, parentContainer, 'MinimapPanel', 'Minimap', options));
    ...
    {
      this.noMinimapDiv = document.createElement('div');
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!./MinimapStyle.css */ "./node_modules/css-loader/index.js!./extensions/Minimap2D/MinimapStyle.css");
...
function requestThumbnail(params) {var size = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'large';
  var docId = params.docId;
  var token = params.token;

  if (!docId || !token) {
    return Promise.reject({ description: 'No document or token for thumbnail', error: 'thumbnail' });
  }
  ...
  var baseURL = Autodesk.Viewing.endpoint.getThumbnailApi();

  var url = [baseURL, docId, '?type=', size];
  if (params.guid) {var _url;
    (_url = url).push.apply(_url, ['&guid=', params.guid]);
  }
  if (params.acmsession) {var _url2;
    (_url2 = url).push.apply(_url2, ['&acmsession=', params.acmsession]);
  }
  url = url.join('');

  return new Promise(function (resolve, reject) {
    sendAjaxRequest(url, token, resolve, reject);
  });
}

function fetchThumbnail(params, thumbnailSize, images) {
  return requestThumbnail(params, thumbnailSize).then(function (thumbnail) {
    var urlCreator = window.URL || window.webkitURL;
    images[thumbnailSize] = urlCreator.createObjectURL(thumbnail);
  });
}

function getAjaxCallback(resolve, reject) {
  return {
    onLoad: function onLoad(event) {
      ...
      event.currentTarget.status === 204) {
        ...
        reject(event.currentTarget.status);
      }
    },
...
function sendAjaxRequest(url, token, resolve, reject) {
...
/***/ "./extensions/Minimap2D/MinimapUtils.js":
/*!**********************************************!*\
  !*** ./extensions/Minimap2D/MinimapUtils.js ***!
  \**********************************************/
/*! exports provided: getModelExtension */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getModelExtension", function() { return getModelExtension; });
function getModelExtension(viewer) {
  var ext = '';
  try {
    var docNode = viewer.model.getDocumentNode();
    var root = docNode.getRootNode();

    var name = '';var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {
      for (var _iterator = root.data.children[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {var child = _step.value;
        if (child.name) {
          name = child.name;
          break;
        }
    ...
    console.log('Error getting model extension', error);
  }
...
/***/ "./node_modules/css-loader/index.js!./extensions/Minimap2D/MinimapStyle.css":
/*!*************************************************************************!*\
  !*** ./node_modules/css-loader!./extensions/Minimap2D/MinimapStyle.css ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
