...
MeasureExtension.prototype.load = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {var self, viewer, measureToolOptions;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
          ...
          viewer.toolController.registerTool(this.measureTool, this.setActive.bind(this));
          ...
          this.viewer.prefs.addListeners(avp.Prefs.DISPLAY_UNITS_PRECISION, this._onPrecisionPrefChanged, this._onPrecisionPrefChanged);case 34:case "end":return _context.stop();}}}, _callee, this);}));
...
proto.renderFromPoints = function (pointData, showMeasureResult) {
  _Indicator__WEBPACK_IMPORTED_MODULE_0__["Indicator"].prototype.renderFromPoints.call(this, pointData, showMeasureResult);
